...
# my_list.append([75,85])
# print("After appending [75,85]:", my_list)
# After appending [75,85]: [10, 20, 80, 40, 30, 40, 50, 60, [75, 85]]

my_list.extend([70, 80])  # Extend the list
print("After extending with [70, 80]:", my_list)
# After extending with [70, 80]: [10, 20, 80, 40, 30, 40, 50, 60, [75, 85], 70, 80]
